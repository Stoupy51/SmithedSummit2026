...
execute if score #recipes_loot stewbeet_summit.page matches ..0 run return 0
...
data merge entity 20180612-2026-2002-2098-202100000006 {interpolation_duration:0,start_interpolation:-1,transformation:{scale:[1.25f,1.25f,1.25f]}}
...
function stewbeet_summit:walls/recipes_loot/fade_out_up
