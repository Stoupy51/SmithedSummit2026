...
# Fade in (down): while the counter (#recipes_loot stewbeet_summit.fc) ticks 2->0, ramp the new text
...
execute if score #recipes_loot stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/recipes_loot/fade_in_down 1t replace
