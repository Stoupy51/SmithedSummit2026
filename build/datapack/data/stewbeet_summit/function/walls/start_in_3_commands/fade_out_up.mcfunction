...
# Fade out (up): while the counter (#start_in_3_commands stewbeet_summit.fc) ticks 2->0, ramp the text
...
execute if score #start_in_3_commands stewbeet_summit.fc matches 0 run schedule function stewbeet_summit:walls/start_in_3_commands/fade_swap_up 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #start_in_3_commands stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/start_in_3_commands/fade_out_up 1t replace
