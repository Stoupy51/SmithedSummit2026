...
scoreboard players remove #wall9 stewbeet_summit.page 1
execute if score #wall9 stewbeet_summit.page matches ..-1 run scoreboard players set #wall9 stewbeet_summit.page 0
function stewbeet_summit:walls/zone_9/show
