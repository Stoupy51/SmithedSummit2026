...
# Fade out (up): while the counter (#what_is_stewbeet stewbeet_summit.fc) ticks 2->0, ramp the text
...
execute if score #what_is_stewbeet stewbeet_summit.fc matches 0 run schedule function stewbeet_summit:walls/what_is_stewbeet/fade_swap_up 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #what_is_stewbeet stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/what_is_stewbeet/fade_out_up 1t replace
