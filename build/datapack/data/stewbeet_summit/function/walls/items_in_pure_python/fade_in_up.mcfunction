...
# Fade in (up): while the counter (#items_in_pure_python stewbeet_summit.fc) ticks 2->0, ramp the new text
...
execute if score #items_in_pure_python stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/items_in_pure_python/fade_in_up 1t replace
