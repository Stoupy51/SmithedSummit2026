...
# Fade out (up): while the counter (#items_in_pure_python stewbeet_summit.fc) ticks 2->0, ramp the text
...
execute if score #items_in_pure_python stewbeet_summit.fc matches 0 run schedule function stewbeet_summit:walls/items_in_pure_python/fade_swap_up 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #items_in_pure_python stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/items_in_pure_python/fade_out_up 1t replace
