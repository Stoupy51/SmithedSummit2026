...
#> stewbeet_summit:walls/my_projects/fade_in_up
#
# @within	stewbeet_summit:walls/my_projects/fade_swap_up 1t replace [ scheduled ]
#			stewbeet_summit:walls/my_projects/fade_in_up 1t replace [ scheduled ]
#

# Fade in (up): while the counter (#my_projects stewbeet_summit.data) ticks 2->0, ramp the new text
...
execute if score #my_projects stewbeet_summit.data matches 1.. run schedule function stewbeet_summit:walls/my_projects/fade_in_up 1t replace
