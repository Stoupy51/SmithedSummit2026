...
#> stewbeet_summit:walls/wip_datapacks/fade_out_down
#
# @executed	positioned 198.5 53.0 -13.5 & rotated 180 0
#
# @within	stewbeet_summit:walls/wip_datapacks/fade_out_down 1t replace [ scheduled ]
#			stewbeet_summit:walls/wip_datapacks/next
#

# Fade out (down): while the counter (#wip_datapacks stewbeet_summit.data) ticks 2->0, ramp the text
...
execute if score #wip_datapacks stewbeet_summit.data matches 0 run schedule function stewbeet_summit:walls/wip_datapacks/fade_swap_down 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #wip_datapacks stewbeet_summit.data matches 1.. run schedule function stewbeet_summit:walls/wip_datapacks/fade_out_down 1t replace
