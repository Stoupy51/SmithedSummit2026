...
#> stewbeet_summit:walls/standing_on_giants/page_2
#
...
data modify entity 20180612-2026-2002-2098-202000000005 text set value ["", {"text": "mecha + bolt (3/7)\n\n", "bold": true, "color": "gold"}, {"text": "mecha", "bold": true, "color": "aqua"}, {"text": " compiles and type-checks every command it emits.\n\n", "color": "white"}, {"text": "bolt", "bold": true, "color": "aqua"}, {"text": " lets you script functions in real Python - loops, vars, if.\n\n", "color": "white"}, ["", {"font": "summit_icons:icons", "translate": "summit_icons.github"}, {"text": " "}, {"text": "github.com/mcbeet/beet/.../bolt", "color": "#8BE9FD", "underlined": true, "click_event": {"action": "open_url", "url": "https://github.com/mcbeet/beet/blob/main/packages/bolt/README.md"}, "hover_event": {"action": "show_text", "value": "Open https://github.com/mcbeet/beet/blob/main/packages/bolt/README.md"}}]]
