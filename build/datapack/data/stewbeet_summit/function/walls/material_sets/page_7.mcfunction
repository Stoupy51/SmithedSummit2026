...
#> stewbeet_summit:walls/material_sets/page_7
#
# @within	stewbeet_summit:walls/material_sets/show
#

# Page 8/9 "Names & Overrides": swap this page's text, wrap width and text scale into the display
data modify entity 20180612-2026-2002-2098-202000000007 text set value ["", {"text": "It reads your names (8/9)\n\n", "bold": true, "color": "gold"}, ["", {"text": "\"steel_ingot\"", "color": "#F1FA8C"}, {"text": "             "}, {"text": "->", "color": "#FF79C6"}, {"text": " "}, {"text": "steel", "color": "#F8F8F2"}, {"text": "\n"}], ["", {"text": "\"minecraft:emerald\"", "color": "#F1FA8C"}, {"text": "     "}, {"text": "->", "color": "#FF79C6"}, {"text": " "}, {"text": "emerald", "color": "#F8F8F2"}, {"text": "\n"}], ["", {"text": "\"adamantium_fragment\"", "color": "#F1FA8C"}, {"text": " "}, {"text": "->", "color": "#FF79C6"}, {"text": " "}, {"text": "adamantium", "color": "#F8F8F2"}, {"text": "\n"}], ["", {"text": "\"awakened_stardust!\"", "color": "#F1FA8C"}, {"text": "  "}, {"text": "->", "color": "#FF79C6"}, {"text": " "}, {"text": "keep", "color": "#F8F8F2"}, {"text": " "}, {"text": "whole", "color": "#F8F8F2"}, {"text": "\n\n"}], {"text": "A trailing ", "color": "white"}, {"text": "!", "bold": true, "color": "aqua"}, {"text": " keeps a multi-word base intact. Set ", "color": "white"}, {"text": "ignore_recipes=True", "bold": true, "color": "aqua"}, {"text": " to keep the items but write the recipes yourself.", "color": "white"}]
