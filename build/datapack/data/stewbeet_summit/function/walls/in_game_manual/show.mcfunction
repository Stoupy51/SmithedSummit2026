...
execute if score #in_game_manual stewbeet_summit.page matches 3 run function stewbeet_summit:walls/in_game_manual/page_3
execute if score #in_game_manual stewbeet_summit.page matches 4 run function stewbeet_summit:walls/in_game_manual/page_4
execute if score #in_game_manual stewbeet_summit.page matches 5 run function stewbeet_summit:walls/in_game_manual/page_5
execute if score #in_game_manual stewbeet_summit.page matches 6 run function stewbeet_summit:walls/in_game_manual/page_6
execute if score #in_game_manual stewbeet_summit.page matches 7 run function stewbeet_summit:walls/in_game_manual/page_7
