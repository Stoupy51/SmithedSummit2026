...
# Fade out (down): while the counter (#in_game_manual stewbeet_summit.fc) ticks 2->0, ramp the text
...
execute if score #in_game_manual stewbeet_summit.fc matches 0 run schedule function stewbeet_summit:walls/in_game_manual/fade_swap_down 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #in_game_manual stewbeet_summit.fc matches 1.. run schedule function stewbeet_summit:walls/in_game_manual/fade_out_down 1t replace
