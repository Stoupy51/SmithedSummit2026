...
#> stewbeet_summit:walls/zone0/page0
#
...
data modify entity @e[tag=stewbeet_summit.disp0,limit=1] text set value ["", {"text": "What is StewBeet?\n\n", "bold": true, "color": "gold"}, {"text": "It is a ", "color": "white"}, [{"text": "B", "color": "#00c400", "italic": false}, {"text": "e", "color": "#558200"}, {"text": "e", "color": "#aa4100"}, {"text": "t", "color": "#ff0000"}], {"text": " framework that brings huge ", "color": "white"}, {"text": "automation", "bold": true, "color": "aqua"}, {"text": " to Minecraft datapacks.\n\n", "color": "white"}, {"text": "You describe ", "color": "white"}, {"text": "what", "bold": true, "color": "gold"}, {"text": " you want in Python. ", "color": "white"}, {"text": "StewBeet generates everything else.", "color": "white"}]
