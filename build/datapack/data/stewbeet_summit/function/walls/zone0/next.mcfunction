...
execute if score #wall0 stewbeet_summit.page matches 4.. run scoreboard players set #wall0 stewbeet_summit.page 4
function stewbeet_summit:walls/zone0/show
