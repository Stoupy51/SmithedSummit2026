...
execute unless entity @e[tag=stewbeet_summit.black_hole] run summon minecraft:item_display 198.5 54.0 -21.5 {"item": {"id": "minecraft:stone", "components": {"minecraft:item_model": "stewbeet_summit:black_hole"}, "count": 1}, "transformation": {"left_rotation": [0.0, 0.0, 0.0, 1.0], "right_rotation": [0.0, 0.0, 0.0, 1.0], "scale": [16.69, 9.69, -18.69], "translation": [0.0, 0.0, 0.0]}, "Tags": ["stewbeet_summit.black_hole"]}
