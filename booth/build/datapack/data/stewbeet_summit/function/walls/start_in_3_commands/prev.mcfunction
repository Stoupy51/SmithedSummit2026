...
execute if score #start_in_3_commands stewbeet_summit.page matches ..0 run return 0
...
data merge entity 20180612-2026-2002-2098-202100000002 {interpolation_duration:0,start_interpolation:-1,transformation:{scale:[1.25f,1.25f,1.25f]}}
...
scoreboard players set #start_in_3_commands stewbeet_summit.data 2
function stewbeet_summit:walls/start_in_3_commands/fade_out_up
