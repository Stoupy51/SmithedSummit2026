...
#> stewbeet_summit:walls/what_is_stewbeet/page_2
#
# @within	stewbeet_summit:walls/what_is_stewbeet/show
#

# Page 3/4 "The Solution": swap this page's text, wrap width and text scale into the display
data modify entity 20180612-2026-2002-2098-202000000000 text set value ["", {"text": "The ", "bold": true, "color": "gold"}, [{"text": "S", "color": "#ff9100", "italic": false}, {"text": "t", "color": "#ff7c00"}, {"text": "e", "color": "#ff6700"}, {"text": "w", "color": "#ff5200"}, {"text": "B", "color": "#ff3e00"}, {"text": "e", "color": "#ff2900"}, {"text": "e", "color": "#ff1400"}, {"text": "t", "color": "#ff0000"}], {"text": " way (3/4)\n\n", "bold": true, "color": "gold"}, {"text": "Declare your items and blocks as ", "color": "white"}, {"text": "Python objects", "bold": true, "color": "gold"}, {"text": ".\n\n", "color": "white"}, {"text": "Get a full ", "color": "white"}, {"text": "datapack", "bold": true, "color": "aqua"}, {"text": " + ", "color": "white"}, {"text": "resource pack", "bold": true, "color": "aqua"}, {"text": ", following community conventions, for free.", "color": "white"}]
