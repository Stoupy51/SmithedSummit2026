...
execute if score #material_sets stewbeet_summit.page matches 8.. run return 0
...
data merge entity 20180612-2026-2002-2098-202200000007 {interpolation_duration:0,start_interpolation:-1,transformation:{scale:[1.25f,1.25f,1.25f]}}
...
scoreboard players set #material_sets stewbeet_summit.data 2
function stewbeet_summit:walls/material_sets/fade_out_down
