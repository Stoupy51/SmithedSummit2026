...
#> stewbeet_summit:walls/released_datapacks/fade_out_up
#
# @executed	positioned 205.5 53.0 -20.5 & rotated 90 0
#
# @within	stewbeet_summit:walls/released_datapacks/fade_out_up 1t replace [ scheduled ]
#			stewbeet_summit:walls/released_datapacks/prev
#

# Fade out (up): while the counter (#released_datapacks stewbeet_summit.data) ticks 2->0, ramp the text
...
execute if score #released_datapacks stewbeet_summit.data matches 0 run schedule function stewbeet_summit:walls/released_datapacks/fade_swap_up 1t replace

# Otherwise: re-run this function next tick and count down
execute if score #released_datapacks stewbeet_summit.data matches 1.. run schedule function stewbeet_summit:walls/released_datapacks/fade_out_up 1t replace
